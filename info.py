...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '7165581725').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '1002033374443') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '1002033374443') # request channel id ( make sure bot is admin )
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Movies4UWorldOfficiall')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/AwaraTeams')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Ultroid_Official/18') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : AwaraTeams')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002071135878')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Movies4UWorldOfficiall') #Support group link ( make sure bot is admin )
...
OWNER_USERNAME = "MeAwara"


# add premium logs channel id
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002033374443'))
